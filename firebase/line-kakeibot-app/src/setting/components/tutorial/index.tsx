  ...
  return (
    <div
      ...
      <div className={styles.tutorialPager} style={pagerStyle}>
        ...
        <div className={styles.tutorialPage}>
          <span className={styles.tutorialText}>まずはレシートの写真を撮ります</span>
        ...
        <div className={styles.tutorialPage}>
          ...
          <span className={styles.tutorialDetails}>登録が終わると、集計結果を送ってきます</span>
          <span className={styles.tutorialText}>操作はこれだけです！</span>
        </div>
        <div className={styles.tutorialPage}>
          <span className={styles.tutorialText}>まずは新しい家計簿を作ってください</span>
        ...
        <div className={styles.tutorialPage}>
          ...
          <span className={styles.tutorialDetails}>使い方説明は設定からいつでも見れます</span>
        </div>
      </div>
